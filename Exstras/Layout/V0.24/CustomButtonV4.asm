; =========================================================================================
; The below relies on LayoutParser V0.24 and all the necessary dependencies to funtion correctly.
; =========================================================================================
...
_NoTimer:
    ...
    ret
_EraseBg:
    mov rsi, rcx            ; Save HWND in a stable register
...
_SnatchedLoop:
    ...
    cmp r12, 128            ; Done with 16 quads?
    jne _SnatchedLoop 
...
RegisterBtn proc
    ...
    mov dword ptr [bwc + 20], 128    ; cbWndExtra (Offset 20) - Your 128 bytes!
