; =========================================================================================
; Module Name: LayoutEngine.asm (v0.24)
; Description: x64 MASM UI Engine Ttributes.
; Feature:     Introduces { } with attributes inside a-z ":" and then attribute up to 1 qword. all sepereated by delimiter ","
; ie "Y,0,500,5,240,160,A,{A:100,b:200,}\c" casing doesn't matter 
; =========================================================================================
...
.data
    ...
    LayoutStr       db "Y,0,500,5,240,160,A,{A:100,b:200,}\c"
...
_Comma:
    ...
    lea rbx,[AttrDataBuffer]
    lea rbx, [AttrDataBuffer + 32] 
    shl r13, 3                     
    add rbx, r13                   
