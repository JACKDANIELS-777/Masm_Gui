; =========================================================================================
; Fixed bug that i fixed in earlier versions that came back sub r14,2 should be sub r14,r12.
; =========================================================================================
...
.data
 ...
 LayoutStr     db "Z!,100,0,0,100,100,{f:83,b:81,}10,\c"
         db "Z,100,0,0,100,100,{f:83,b:82,}10,\c",0
