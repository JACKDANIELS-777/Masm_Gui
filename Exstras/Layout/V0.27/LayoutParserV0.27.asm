; =========================================================================================
; Added in P Control P ZP BP YP etc that makes use of percentages need still to take care of the remainder.
; =========================================================================================
...
.data
 ...
 LayoutStr     db "ZP,100,50,50,100,100,{f:83,b:81,}10,\c",0
