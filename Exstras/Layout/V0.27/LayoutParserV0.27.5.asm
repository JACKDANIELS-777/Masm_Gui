; =========================================================================================
; Fixed the Z! ZP! ZP! wouldnt work for obvios reasons 
; Now doesnt matter the case ZP! works ZAP! etc should work 
; =========================================================================================
...
.data
 ...
 LayoutStr     db "ZP!,0,0,0,100,100,{f:83,b:81,}10,\c"
         db "Z,0,0,0,100,100,{f:83,b:81,}10,\c",0
  ;also works seems all test cases pass.                 
 ;LayoutStr     db "Y!,0,0,0,100,100,{f:83,b:81,}10,\c"
         ;db "(ZPA,0,0,0,100,100,{f:81,b:92,}10,\c)",0
...
_Type:
    ...
    _Delayed:       mov rcx, 0
                    ...
                    _loop1:
                        ...
                        dec r14
                        dec r12
                        jnz _loop1          ; "jnz" is 1 byte shorter than "cmp r12, 0 / jne"
    ...
    _WindowManager:
        movzx rdi,byte ptr[WindowManager]
        cmp rdi,0
        jne _NoConfigure
...
_add_control:
    ...
    mov rax, qword ptr[WindowManager]
    cmp rax,2
...
_Percent:
    ...
    mov r10,qword ptr[rsp+90h]
    mov r11,qword ptr[rsp+98h]
