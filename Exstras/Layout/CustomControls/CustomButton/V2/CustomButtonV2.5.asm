...
; Added more animations. Animations arent yet standarized yet.
; ##Each Animation has certain criterea to be met thats why animation 4 skips 3 and 2.
; Animation 4 requires certain things in point 3 and 2 the same and 1 the same. A tutorial will follow later on hopefully.
; =========================================================================================
