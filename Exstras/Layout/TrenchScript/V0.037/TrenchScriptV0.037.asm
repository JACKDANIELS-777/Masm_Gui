...
includelib Masm_api2.lib ;on my github find the dll and this .lib
extern Main_func:proc
    ...
    MovRDDVl qword  "MovRDDVl"
    BswapR   qword  "BswapR  "
    ForL     qword  "ForL    "
    EndFL     qword "EndFL   "
    CallGenP  qword  "CallGenP"
    SwapRR qword    "SwapRR  "
    ...
    Command_Table dq "MsgB    ", MsgB
        ...
        dq "MovRDDVl",MovRDDVl

        dq "BswapR  ",BswapR
        dq "ForL    ",ForL
        dq "EndFL   ",EndFL
        dq "CallGenP",CallGenP
        dq SwapRR ,    "SwapRR  "
...
_CallGenP:
    ...
    _BswapR:
        ...
        cmp rax, 3
        je _Bswap_rbx
        ; Skip 4 (rsp) / 5 (rbp) to protect the Sovereign Stack
        cmp rax, 6
        je _Bswap_rsi
        cmp rax, 7
        je _Bswap_rdi
