...
extern TrenchScriptProc  : proc


extern MainHandle:qword
extern RegisterEdit:proc
extern EditClassName:byte
...
.data
 ...
 LayoutStr     db "Z,101,10,10,100,100,{f:10,b:17,}Edit here,\c",0
