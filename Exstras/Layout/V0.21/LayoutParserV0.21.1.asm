; =========================================================================================
; MASM x64 Layout Engine v0.21.1
...
.data
   ...
   LayoutStr   db "Y,0,5,5,240,160,A,\c",0
...
;Still in progress 
; need to setup multithreading correctly 
CreateThreads proc
...
_add_control:
    ...
    mov qword ptr[ThreadData+72],rbx
   ...
   mov qword ptr[ThreadData+8],rdx
    ...
    mov qword ptr[ThreadData+16],r8
    ...
    call CheckWin
     ...
     mov qword ptr[ThreadData+24],r9

    mov r10, qword ptr[rsp+16]
     mov qword ptr[ThreadData+32],r10


    mov r11, qword ptr[rsp+24]
    mov qword ptr[ThreadData+40],r11
     
    mov r12, qword ptr[rsp+32]
    mov qword ptr[ThreadData+48],r12

    mov r13, qword ptr[rsp+40]
    mov qword ptr[ThreadData+56],r13


    mov r14, hwndMain
    mov qword ptr[ThreadData+64],r14
    
    mov r15, 0
   mov qword ptr[ThreadData+72],r15
