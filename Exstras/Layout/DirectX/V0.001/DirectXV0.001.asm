;Fixed the addresses. Addresses mayb vary between pcs because of how the tables are setup
; Direct x uses alot more ramn roughly 22.5 mb on startup just a blank window with color.
...
mov edx, 1
lea r8, [MyVP]
call qword ptr [rax + 160h] ; RSSetViewports
